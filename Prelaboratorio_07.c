/* 
 * File:   Prelaboratorio_07.c
 * Author: sando
 *
 * Created on 6 de abril de 2022, 04:41 PM
 */
/*
...
void main(void) {                   
    ...
    while(1){
        ...
        if (!BOTON1){          // Si, RB0 esta encendido PORTA decrementa
            PORTA++;
            __delay_ms(500);
        }
        if (!BOTON2){          // Si, RB1 esta encendido PORTA decrementa
            PORTA--;
            __delay_ms(500);
        }
    }
